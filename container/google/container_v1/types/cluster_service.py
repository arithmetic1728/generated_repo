...
class Cluster(proto.Message):
    ...
    Attributes:
        ...
        initial_node_count (int):
            ...
            ensure that your Compute Engine resource quota is sufficient
            ...
            create a "NodePool" object with an auto-generated name. Do
...
class NodePool(proto.Message):
    ...
    Attributes:
        ...
        initial_node_count (int):
            ...
            ensure that your Compute Engine <a
            href="/compute/docs/resource-quotas">resource
            quota</a> is sufficient for this number of
            instances. You must also have available firewall
            and routes quota.
        self_link (str):
            [Output only] Server-defined URL for the resource.
        version (str):
...
class MaintenanceWindow(proto.Message):
    ...
    daily_maintenance_window = proto.Field(proto.MESSAGE, number=2,
        message='DailyMaintenanceWindow',
    )
    recurring_window = proto.Field(proto.MESSAGE, number=3,
